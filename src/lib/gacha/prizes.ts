...
export const GACHA_PRIZES: readonly GachaPrize[] = [
  ...
  { id: "interior_ragby_ar", name: "ラグビーアー", rarity: "LR", type: "item", pool: "regular", image: "/collection/items/ragby-ar.png" },
  ...
  { id: "other_xmas_party", name: "Xmas Party", rarity: "MR", type: "item", pool: "regular", image: "/collection/items/xmas-party.png" },
