...
export const GACHA_PRIZES: readonly GachaPrize[] = [
  ...
  { id: "other_narcissist_a", name: "ナルシストアー", rarity: "MR", type: "item", image: "/collection/items/narcissist-a.webp" },
  { id: "other_mafia_a", name: "マフィアー", rarity: "MR", type: "item", image: "/collection/items/mafia-a.webp" },
  ...
  { id: "sushi_salmon", name: "サーモン握り", rarity: "R", type: "item", image: "/collection/items/sushi-salmon.webp" },
  { id: "sushi_maguro_akami", name: "まぐろ(赤身)握り", rarity: "R", type: "item", image: "/collection/items/sushi-maguro-akami.webp" },
  { id: "sushi_ika", name: "いか握り", rarity: "R", type: "item", image: "/collection/items/sushi-ika.webp" },
  { id: "sushi_tako", name: "たこ握り", rarity: "R", type: "item", image: "/collection/items/sushi-tako.webp" },
  { id: "sushi_hotate", name: "ほたて握り", rarity: "R", type: "item", image: "/collection/items/sushi-hotate.webp" },
  { id: "sushi_chutoro", name: "中トロ握り", rarity: "SR", type: "item", image: "/collection/items/sushi-chutoro.webp" },
  { id: "sushi_buri", name: "ぶり握り", rarity: "SR", type: "item", image: "/collection/items/sushi-buri.webp" },
  { id: "sushi_kanpachi", name: "かんぱち握り", rarity: "SR", type: "item", image: "/collection/items/sushi-kanpachi.webp" },
  { id: "sushi_ebi", name: "えび握り", rarity: "SR", type: "item", image: "/collection/items/sushi-ebi.webp" },
  { id: "sushi_aburi_saba", name: "炙りサバ握り", rarity: "SR", type: "item", image: "/collection/items/sushi-aburi-saba.webp" },
  { id: "sushi_otoro", name: "大トロ握り", rarity: "UR", type: "item", image: "/collection/items/sushi-otoro.webp" },
  { id: "sushi_anago", name: "穴子握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-anago.webp" },
  { id: "sushi_uni", name: "うに握り", rarity: "UR", type: "item", image: "/collection/items/sushi-uni.webp" },
  { id: "sushi_shirasu", name: "生しらす握り", rarity: "UR", type: "item", image: "/collection/items/sushi-shirasu.webp" },
  { id: "sushi_nama_ebi", name: "生えび握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-nama-ebi.webp" },
  { id: "sushi_bincho", name: "びんちょうまぐろ握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-bincho.webp" },
  { id: "sushi_negishio_maguro", name: "ネギ塩マグロ握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-negishio-maguro.webp" },
  { id: "sushi_engawa", name: "えんがわ握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-engawa.webp" },
  { id: "sushi_onion_salmon", name: "オニオンサーモン握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-onion-salmon.webp" },
  { id: "sushi_mirugai", name: "みる貝握り", rarity: "SSR", type: "item", image: "/collection/items/sushi-mirugai.webp" },
  { id: "sushi_fugu", name: "ふぐ握り", rarity: "UR", type: "item", image: "/collection/items/sushi-fugu.webp" },
  ...
  { id: "sushi_akagai", name: "赤貝握り", rarity: "SR", type: "item", image: "/collection/items/sushi-akagai.webp" },
