...
export const ITEM_CATCH_SKILLS: readonly ItemCatchSkill[] = [
  ...
  // --- SR --------------------------------------------------------
  { id: "toy_treasure_puzzle", levels: ["+25pt / +50pt / +3秒", "+30pt / +65pt / +4秒", "+40pt / +80pt / +5秒", "+50pt / +100pt / +6秒", "+60pt / +130pt / +8秒"], note: "8つの中から重み付きで1つがランダムで出る（低pt17% / 高pt10% / +秒15% / うんち祭り10個10% / -5秒10% / 数秒間得点×2 15% / 数秒間SSR/UR/LRのみ出現15% / 次の宝箱まで得点+20〜40%8%）。ハズレ(うんち祭り・-5秒)は合計20%" },
  ...
  // --- MR --------------------------------------------------------
  { id: "other_burebur", levels: ["5体", "7体", "9体", "11体", "13体"], note: "指定数のアイテムが出現するまで、SSR・UR・LRランクのアイテムしか出現しなくなる" },
