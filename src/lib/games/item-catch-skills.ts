...
export const ITEM_CATCH_SKILLS: readonly ItemCatchSkill[] = [
  ...
  { id: "food_mocchurin", levels: ["+20pt / エコー40%", "+25pt / エコー55%", "+30pt / エコー70%", "+40pt / エコー85%", "+50pt / エコー100%"], note: "捕まえた瞬間に、自分より直前に捕まえたアイテムのスキルをもう一度発動する（発動確率はLvで上昇し、Lv.MAXで確定）。エコー対象は本来のレベルのまま再発動する" },
