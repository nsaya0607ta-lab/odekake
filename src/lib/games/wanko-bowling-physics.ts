...
/** スマホ操作を実投球らしい範囲へ収めるゲーム用速度レンジ。 */
export const GAME_MIN_BALL_SPEED_KMH = 18;
export const GAME_MAX_BALL_SPEED_KMH = 31;
...
export const BACKEND_HOOK_ACCEL_MPS2 = 1.15;
