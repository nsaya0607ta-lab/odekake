...
const CURATED_ITEMS: readonly CollectionItem[] = [
  ...
  { id: "sushi_salmon", name: "サーモン握り", image: "/collection/items/sushi-salmon.webp", category: "food", series: "sushi", rarity: "R" },
  { id: "sushi_maguro_akami", name: "まぐろ(赤身)握り", image: "/collection/items/sushi-maguro-akami.webp", category: "food", series: "sushi", rarity: "R" },
  { id: "sushi_ika", name: "いか握り", image: "/collection/items/sushi-ika.webp", category: "food", series: "sushi", rarity: "R" },
  { id: "sushi_tako", name: "たこ握り", image: "/collection/items/sushi-tako.webp", category: "food", series: "sushi", rarity: "R" },
  { id: "sushi_hotate", name: "ほたて握り", image: "/collection/items/sushi-hotate.webp", category: "food", series: "sushi", rarity: "R" },
  { id: "sushi_chutoro", name: "中トロ握り", image: "/collection/items/sushi-chutoro.webp", category: "food", series: "sushi", rarity: "SR" },
  { id: "sushi_buri", name: "ぶり握り", image: "/collection/items/sushi-buri.webp", category: "food", series: "sushi", rarity: "SR" },
  { id: "sushi_kanpachi", name: "かんぱち握り", image: "/collection/items/sushi-kanpachi.webp", category: "food", series: "sushi", rarity: "SR" },
  { id: "sushi_ebi", name: "えび握り", image: "/collection/items/sushi-ebi.webp", category: "food", series: "sushi", rarity: "SR" },
  { id: "sushi_aburi_saba", name: "炙りサバ握り", image: "/collection/items/sushi-aburi-saba.webp", category: "food", series: "sushi", rarity: "SR" },
  { id: "sushi_otoro", name: "大トロ握り", image: "/collection/items/sushi-otoro.webp", category: "food", series: "sushi", rarity: "UR" },
  { id: "sushi_anago", name: "穴子握り", image: "/collection/items/sushi-anago.webp", category: "food", series: "sushi", rarity: "SSR" },
  ...
  { id: "sushi_fugu", name: "ふぐ握り", image: "/collection/items/sushi-fugu.webp", category: "food", series: "sushi", rarity: "UR" },
  { id: "sushi_kani", name: "カニ身握り", image: "/collection/items/sushi-kani.webp", category: "food", series: "sushi", rarity: "UR" },
  { id: "sushi_oomonhata", name: "オオモンハタ握り", image: "/collection/items/sushi-oomonhata.webp", category: "food", series: "sushi", rarity: "UR" },
  { id: "sushi_unagi", name: "うなぎ握り", image: "/collection/items/sushi-unagi.webp", category: "food", series: "sushi", rarity: "UR" },
