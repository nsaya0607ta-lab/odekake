    ...
    <>
      ...
      <PageBody>
        ...
        <nav>
          ...
          <ul className="rough-card divide-y divide-line overflow-hidden">
            <MenuItem href="/mypage/visit-shortcut" icon={<span className="text-lg leading-none">📍</span>} label="ショートカット場所登録" />
            <MenuItem href="/mypage/step-sync" icon={<span className="text-lg leading-none">👟</span>} label="歩数連携（iPhone・Android）" />
