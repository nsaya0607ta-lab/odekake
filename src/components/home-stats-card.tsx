 ...
 *
 * - 数字の下端（ベースライン）: y 597 → 下から 39.5%
 * - 「/」の左端: x 348 / 749 / 1284。数と「/」の間は、絵の中の「/ 47」と同じ 18px あける
 *
 * 訪問数だけは「/ 回」を絵の中で右へ 46px ずらし（破線の右端 x1366 に「回」をそろえた）、
 * 数を書ける幅を 220px まで広げてある。10000回を超えて6桁になっても区切り線に当たらない。
 */
const VALUE_BOTTOM = "39.5%";
const VALUE_RIGHT = {
  prefectures: "79.3%",
  municipalities: "54.2%",
  visits: "20.7%",
