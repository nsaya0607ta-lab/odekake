...
const SAMPLES: readonly ShopSample[] = [
  {
    ...
    before: (
      <>
        ...
        <img src="/characters/frenchie/normal/lie.webp" alt="" className={DOG} draggable={false} />
      </>
    ),
    after: (
      <>
        ...
        <img src="/characters/frenchie/normal/doze.webp" alt="" className={DOG} draggable={false} />
  ...
  },
  {
    ...
    before: (
      <>
        <span className={FLOOR} />
        <span className="absolute inset-x-0 bottom-[22%] h-px bg-[#e0cba4]" />
        <img src="/characters/frenchie/normal/lie-wave.webp" alt="" className={DOG} draggable={false} />
  ...
  },
  {
    ...
    before: (
      <>
        ...
        <RainDrops />
        <img
          src="/characters/frenchie/normal/sit-side.webp"
          alt=""
