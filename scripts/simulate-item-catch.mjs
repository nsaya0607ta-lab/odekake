...
const NORMAL_ITEM_IDS = new Set([
  ...
  "sushi_onion_salmon", "sushi_mirugai",
...
function simulateOneRound(lv, catchAll, timeBonusCatchRate = 0.8, normalCatchRate = 0.85, denseCatchRate = 0.5) {
  ...
  function runItemSkillEffect(skillId, lvIdx) {
    ...
    switch (skillId) {
      ...
      case "sushi_mirugai": nextMultValue = LV.MIRUGAI_MULT[lvIdx]; nextMultCount = LV.MIRUGAI_COUNT[lvIdx]; break;
      ...
      case "sushi_bincho": addBonusTime(LV.BINCHO_SEC[lvIdx]); points += LV.BINCHO_PT[lvIdx]; break;
